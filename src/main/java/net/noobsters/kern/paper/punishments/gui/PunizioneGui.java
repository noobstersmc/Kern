...
public class PunizioneGui {
    ...
    public PunizioneGui(String name, int penalties, String description) {
        ...
        .addLore(ChatColor.WHITE + "+1 penaltie point", ChatColor.GRAY + "Ban " + penalties*12 + " hours").build();
        ...
        .addLore(ChatColor.WHITE + "+1 penaltie point", ChatColor.GRAY + "Mute " + penalties*2 + " hours").build();
        ...
        .addLore(ChatColor.WHITE + "+3 penaltie points", ChatColor.GRAY + (penalties >= 12 ? "Ban " : "Mute ") + penalties + " days").build();
        ...
        .addLore(ChatColor.WHITE + "+12 penaltie points", ChatColor.GRAY + "Undefined ban").build();
